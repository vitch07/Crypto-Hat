...
function CreatorCard({ rank, creatorImage, creatorName, creatorEths }) {
  return (
    <div className="min-w-190 minlg:min-w-240 bg-white border border-nft-gray-1 rounded-3xl flex flex-col p-4 m-4">
      ...
      <div className="mt-3 minlg:mt-7 text-center flexCenter flex-col">
        ...
        <p className="mt-1 font-poppins text-nft-black-1 font-semibold text-base">
